# Script de Instalación Automatizada y Segura de Nextcloud 33

Este repositorio contiene un script interactivo en Bash diseñado para desplegar de forma completamente automática, eficiente y segura un entorno de producción para **Nextcloud 33 (Hub 9)** en **Ubuntu Server 26.04 LTS**. 
